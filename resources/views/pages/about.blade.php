            ...
            <div class="row">
                <div class="col-12 col-sm-4">
                    <div class="list-group" id="list-tab" role="tablist">
                        <a class="list-group-item list-group-item-action active" id="list-dev-list" data-toggle="list" href="#list-dev" role="tab" aria-controls="dev">Development</a>
                        <a class="list-group-item list-group-item-action" id="list-maintenance-list" data-toggle="list" href="#list-maintenance" role="tab" aria-controls="maintenance">Maintenance</a>
                        <a class="list-group-item list-group-item-action" id="list-hosting-list" data-toggle="list" href="#list-hosting" role="tab" aria-controls="hosting">Hosting</a>
                        <a class="list-group-item list-group-item-action" id="list-ff-list" data-toggle="list" href="#list-ff" role="tab" aria-controls="ff">Freestyle</a>
                    </div>
                </div>
