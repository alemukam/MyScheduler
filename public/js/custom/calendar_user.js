    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.user.length == 0) {
                ...
                $('#u_events_render').html('<p>You have no personal events on this day. Enjoy free time :)</p>');
            } else {
                $('#u_events').show();
            ...
            if (data.group.length == 0) {
                ...
                $('#g_events_render').html('<p>You have no group events on this day. Enjoy free time :)</p>');
            } else {
                $('#g_events').show();
